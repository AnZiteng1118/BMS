...
public class DeviceScanActivity extends ListActivity {
	...
	public static String UUID_CHARB = "0000fffb-0000-1000-8000-00805f9b34fb";
	public static String UUID_CHARC = "0000fffc-0000-1000-8000-00805f9b34fb";
	public static String UUID_CHARD = "0000fffd-0000-1000-8000-00805f9b34fb";
	...
	static BluetoothGattCharacteristic gattCharacteristic_charB = null;
	static BluetoothGattCharacteristic gattCharacteristic_charC = null;
	static BluetoothGattCharacteristic gattCharacteristic_charD = null;
	...
	private void displayGattServices(List<BluetoothGattService> gattServices) {
		...
		for (BluetoothGattService gattService : gattServices) {
			...
			for (final BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
				...
				if (gattCharacteristic.getUuid().toString().equals(UUID_CHARB)) {
					gattCharacteristic_charB = gattCharacteristic;
				}
				
				if (gattCharacteristic.getUuid().toString().equals(UUID_CHARC)) {
					gattCharacteristic_charC = gattCharacteristic;
				}
				
				if (gattCharacteristic.getUuid().toString().equals(UUID_CHARD)) {
					gattCharacteristic_charD = gattCharacteristic;
				}
				// -----Descriptors的字段信�?----//
